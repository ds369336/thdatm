...
--=================== DataBase 08/05/2015 ==================
--ATMBANKPROCESS เก็บสถานะล่าสุดที่ GEN ไฟล์ส่งเข้า BANK จากตาราง ATMBANKWAITPROCRESS
...
DROP TABLE "ATMBANKWAITPROCRESS";
CREATE TABLE "ATMBANKWAITPROCRESS" ("COOP_ID" VARCHAR2(10) NOT NULL, "MEMBER_NO" CHAR(8) NOT NULL, "INSERT_DATE" DATE DEFAULT SYSDATE, "DATA_TYPE" NUMBER(1,0) DEFAULT 1, "DELETE_FLAG" NUMBER(1,0) DEFAULT 0, "PROCESS_FLAG" NUMBER(1,0) DEFAULT 8, "PROCESS_DATE" DATE);
ALTER TABLE "ATMBANKWAITPROCRESS" ADD ( CONSTRAINT "PK_ATMBANKWAITPROCRESS" PRIMARY KEY ( "COOP_ID", "MEMBER_NO", "INSERT_DATE" ));

--DATE_TYPE [1:INFOMATION, 2:LOAN_RECEIVE, 3:DEPOSIT_WITHDRAW, 4:LOAN_PAYMENT, 5:DEPOSIT_DEPOSIT]
