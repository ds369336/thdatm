...
ALTER TABLE "ATMMEMBER" ADD ( CONSTRAINT "PK_ATMDEPT" PRIMARY KEY ( "COOP_ID", "MEMBER_NO" )) ;
...
ALTER TABLE "ATMDEPT" ADD ( CONSTRAINT "PK_ATMDEPT" PRIMARY KEY ( "COOP_ID", "MEMBER_NO" )) ;
...
--DATA_TYPE [0:DELETE_ALL, 1:INFOMATION, 2:LOAN_RECEIVE, 3:DEPOSIT_WITHDRAW, 4:LOAN_PAYMENT, 5:DEPOSIT_DEPOSIT]
